...
def main():
    ...
    print("Input to make stock primers of 100uM in the original plate using Biomek i7:")
    ...
    print("Input to make working solution of primers (10 uM) in microtitter plate using Biomek i7:")
    ...
    print(f"USER: {output_file3} and {output_file4}")


    combine_frags = mix_primers.combine_fw_rv_primers(working_primers, destination_plate="comb_frags_gg")
    print("Input to combine 2 fragments for gene assemble using Biomeki7:")
    ...
    print("Congratz \o/ you have successfully generated the primers and the input files necessary \n" \
